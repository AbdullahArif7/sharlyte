...
export const metadata: Metadata = {
  title: "Contact Us | Sharlyte Staffing Solutions",
  description: "Get in touch with Sharlyte Staffing Solutions. We are here to help facilities and healthcare professionals connect.",
};
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans antialiased text-deep-plum bg-soft-ivory transition-colors duration-300">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden bg-white">
        ...
        <div className="absolute top-20 right-[10%] w-64 h-64 bg-warm-gold/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-10 left-[5%] w-48 h-48 bg-deep-plum/5 rounded-full blur-2xl"></div>
        ...
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading font-light tracking-tight text-slate-900 mb-10 leading-[1.05]">
              Let's Start a <br />
              <span className="text-warm-gold italic font-extralight">Conversation.</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-500 max-w-3xl mx-auto font-light leading-relaxed">
              We connect healthcare facilities with top-tier medical professionals. With Sharlyte, you receive the personalized care of a small agency and the performance results of a large-scale provider.
            </p>
          </div>
        </div>
        ...
        <div className="absolute -left-20 -bottom-20 w-[500px] h-[500px] md:w-[700px] md:h-[700px] opacity-[0.10] pointer-events-none grayscale">
          <Image
            src="/images/icon.png"
            alt=""
            fill
      ...
      {/* 2. Glassmorphic Contact Info Section */}
      <section className="py-24 bg-soft-ivory relative overflow-hidden">
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            {/* Address - Glassmorphic */}
            <div className="backdrop-blur-md bg-white/70 p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/40 flex flex-col items-center text-center group hover:bg-white hover:shadow-xl transition-all duration-500">
              <div className="w-16 h-16 rounded-full bg-warm-gold/10 flex items-center justify-center text-warm-gold mb-8 group-hover:scale-110 group-hover:bg-warm-gold group-hover:text-white transition-all duration-500">
              ...
              <h3 className="text-xl font-heading font-medium text-slate-900 mb-4">Visit Us</h3>
            ...
            <div className="backdrop-blur-md bg-white/70 p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/40 flex flex-col items-center text-center group hover:bg-white hover:shadow-xl transition-all duration-500">
              ...
              <h3 className="text-xl font-heading font-medium text-slate-900 mb-4">Message Us</h3>
              <p className="text-slate-500 font-light leading-relaxed">
            ...
            <div className="backdrop-blur-md bg-white/70 p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/40 flex flex-col items-center text-center group hover:bg-white hover:shadow-xl transition-all duration-500">
              ...
              <h3 className="text-xl font-heading font-medium text-slate-900 mb-4">Direct Line</h3>
              <p className="text-slate-500 font-light leading-relaxed">
                (214) 501-5651<br />Mon-Fri, 9am-5pm
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 3. Form Section - Premium Dark/Light Contrast */}
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="w-full max-w-[1200px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[10px] font-bold text-warm-gold uppercase tracking-[0.4em] mb-6">Send a Message</h2>
            <h3 className="text-3xl md:text-5xl font-heading font-light text-slate-900 leading-[1.1] mb-8">
              How can we <br />
              <span className="text-warm-gold font-extralight italic">Help You Today?</span>
            </h3>
            <p className="text-lg text-slate-500 font-light leading-relaxed">
              Whether you're a facility looking for talent or a professional seeking your next role, our team is here to support you. Send us a message and we'll respond within 24 hours.
            </p>
          </div>

          <div className="bg-[#F8F6FA] p-8 md:p-12 lg:p-16 rounded-[3rem] border border-deep-plum/5 shadow-sm max-w-5xl mx-auto relative group overflow-hidden">
            {/* Subtle Gradient Overlay on Hover */}
            <div className="absolute inset-0 bg-gradient-to-br from-warm-gold/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none"></div>
            
            <form className="space-y-8 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Your Name *</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Your Email *</label>
                  <input 
                    type="email" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Phone Number *</label>
                  <input 
                    type="tel" 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Your Message *</label>
                <textarea 
                  rows={6}
      ...
      <section className="py-32 bg-deep-plum relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h3 className="text-3xl md:text-5xl font-heading font-light text-white mb-10">
            Partnering for <br />
            <span className="italic font-extralight text-warm-gold">Healthcare Excellence.</span>
          </h3>
          <p className="text-lg text-slate-400 font-light mb-12">
            Discover why Sharlyte is the preferred choice for healthcare facilities and medical professionals nationwide.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="/about" className="w-full sm:w-auto inline-flex h-14 items-center justify-center gap-8 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm px-10 text-base font-medium text-white transition-all hover:bg-white/10">
              Meet Our Team
            </Link>
          </div>
        </div>
