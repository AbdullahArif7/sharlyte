...
export const metadata: Metadata = {
  title: "Find a Job | Sharlyte Staffing Solutions",
  description: "Discover rewarding healthcare opportunities. Join Sharlyte to explore flexible, high-paying positions that match your skills.",
};
        ...
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading font-light tracking-tight text-slate-900 mb-10 leading-[1.05]">
              ...
              <span className="text-warm-gold italic">Healthcare Role.</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-500 max-w-3xl mx-auto font-light leading-relaxed">
              Discover rewarding healthcare opportunities. Join Sharlyte to explore flexible, high-paying positions that match your skills, schedule, and career goals.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-[1200px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-heading font-light text-slate-900 leading-[1.1] mb-8">
              Connect with our <br />
              <span className="text-warm-gold font-extralight italic">Recruitment Experts.</span>
            </h3>
            <p className="text-lg text-slate-500 font-light leading-relaxed">
              Fill out the form to connect with Sharlyte. Our team will review your application and get back to you with healthcare opportunities that match your professional goals.
            </p>
          </div>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Full Name *</label>
                  <input 
                    type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Location *</label>
                  <input 
                    type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Zip Code *</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Industry *</label>
                  <select 
                    className="w-full h-14 bg-white border border-slate-200 rounded-2xl px-6 text-deep-plum focus:outline-none focus:ring-2 focus:ring-warm-gold/20 focus:border-warm-gold transition-all appearance-none cursor-pointer"
                    defaultValue=""
                    required
                  >
                    <option value="" disabled>Select Industry</option>
                    <option value="Local Healthcare">Local Healthcare</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Years of Experience *</label>
                  <input 
                    type="number" 
                    placeholder="Number"
                    className="w-full h-14 bg-white border border-slate-200 rounded-2xl px-6 text-deep-plum focus:outline-none focus:ring-2 focus:ring-warm-gold/20 focus:border-warm-gold transition-all"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-deep-plum uppercase tracking-widest ml-1">Upload Your Resume *</label>
                  <div className="relative h-14">
                    <input 
                      ...
                      required
                    />
                    <div className="w-full h-full bg-white border border-slate-200 rounded-2xl px-6 flex items-center justify-between text-slate-400">
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="agree" className="text-sm text-slate-600 font-light">
                  I agree to the terms and conditions and consent to be contacted regarding my application.
                </label>
              </div>
      ...
      <section className="py-32 bg-deep-plum relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h3 className="text-3xl md:text-5xl font-heading font-light text-white mb-10">
            ...
            <span className="italic font-extralight text-warm-gold">in your medical career.</span>
          </h3>
          <p className="text-lg text-slate-400 font-light mb-12">
            Whether you're looking for flexibility or a full-time commitment, Sharlyte connects you with the best healthcare facilities.
          </p>
